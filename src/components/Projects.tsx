...
const Projects = () => {
    ...
    const fetchRepos = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/users/Atharva-Werulkar/repos?sort=pushed&direction=desc&per_page=10"
        );
        if (!response.ok) {
  ...
  return (
    <section
      id="projects"
      className="min-h-screen bg-black text-white relative overflow-hidden scroll-mt-20"
    >
      {/* Background Grid */}
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8 pt-8 pb-8 sm:pt-12 sm:pb-12 lg:pt-16 lg:pb-16">
        ...
        <div className="max-w-6xl mx-auto font-sans">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Project Card with ref for scroll animation */}
            <div
              ref={(el) => (projectRefs.current[currentIndex] = el)}
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-8 transform transition-all duration-500 hover:scale-105 hover:border-white/20">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-gray-400 text-sm">
                      <div className="flex items-center space-x-1">
                        <Calendar size={14} />
                        <span>
                          {formatDate(repos[currentIndex].updated_at)}
                        </span>
                      </div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-1 text-yellow-400">
                      ...
                      <span className="text-sm">
                        {repos[currentIndex].stargazers_count}
                      </span>
                    </div>
                    <div className="flex items-center space-x-1 text-gray-400">
                      <GitFork size={14} />
                      <span className="text-sm">
                        {repos[currentIndex].forks_count}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 mb-6 leading-relaxed text-lg">
                  {repos[currentIndex].description ||
                    "A carefully crafted project showcasing modern development practices."}
                </p>
        ...
        <div className="text-center mt-16 opacity-0 animate-fade-in-up delay-400">
